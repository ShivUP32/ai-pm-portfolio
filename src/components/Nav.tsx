        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 right-0 bottom-0 h-full w-[300px] max-w-[85vw] z-50 bg-[#050505]/75 backdrop-blur-xl border-l border-white/10 shadow-2xl flex flex-col md:hidden"
            >
              {/* Drawer Header */}
